...
`Aku sudah menyiapkan transaksi mint. Silakan sign transaction block ini dengan wallet Sui kamu. Jangan pernah membagikan private key atau seed phrase. Setelah wallet memberi signature, kirim signature itu ke sini agar aku submit mint-nya.`

When mint succeeds:

`Mint berhasil. Kamu menerima 10,000,000 SHIT di Sui testnet. Tx digest: <digest>.`

When multiple mints succeed:

`Mint selesai. Berhasil <count>x mint, total <amount> SHIT di Sui testnet. Tx digest: <digests>.`
